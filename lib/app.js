...
const MAPPINGS = {
  ...
  aboutDeveloperName: ["ds:5", 1, 2, 69, 4, 0],
  aboutDeveloperEmail: ["ds:5", 1, 2, 69, 4, 1, 0],
  aboutDeveloperAddress: {
    path: ["ds:5", 1, 2, 69, 4, 2, 0],
    fun: (searchArray) => {
      const street = searchArray.split("\n")[0];
      const city = searchArray.split("\n")[1];
      const country = searchArray.split("\n")[2];
      return {
        street,
        city,
        country,
  ...
  aboutDeveloperNumber: ["ds:5", 1, 2, 69, 4, 3],
  developerInternalID: {
    path: ['ds:5', 1, 2, 68, 1, 4, 2],
    fun: (devUrl) => devUrl.split('id=')[1]
  },
