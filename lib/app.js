...
function app (opts) {
  return new Promise(function (resolve, reject) {
    ...
    const reqUrl = new URL(PLAYSTORE_URL);
    reqUrl.searchParams.append('id', opts.appId);
    reqUrl.searchParams.append('hl', opts.lang);
    reqUrl.searchParams.append('gl', opts.country);
