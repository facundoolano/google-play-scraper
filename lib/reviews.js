...
function getUserImage($, handle) {
  const spanElem = $(handle).find('span[class=responsive-img-hdpi]').find('span')[0];
  const style = spanElem && spanElem.attribs && spanElem.attribs.style;
  // Style is in the form of background-image:url(https://lh5.googleusercontent.com/.../photo.jpg)
