...
function parseFields($) {
	...
	reviewsContainer.each(function(i) {
		...
		var developerComment = $(this).next().first();
		if (developerComment.attr("class") == "developer-reply")
		{
			var devDate = developerComment.find("span.review-date").text().trim();
			var devText = developerComment.clone().children().remove().end().text().trim();
		}
