...
const PATHS = {
  TOP_FREE: `${CLUSTER_BASE_URL}/top`,
  TOP_PAID: `${CLUSTER_BASE_URL}/top`,
  GROSSING: `${CLUSTER_BASE_URL}/top`,
  TOP_FREE_GAMES: `${CLUSTER_BASE_URL}/top`,
  TOP_PAID_GAMES: `${CLUSTER_BASE_URL}/top`,
  TOP_GROSSING_GAMES: `${CLUSTER_BASE_URL}/top`,
  TRENDING: `${CLUSTER_BASE_URL}/top`,
  NEW_FREE: `${CLUSTER_BASE_URL}/new`,
  NEW_PAID: `${CLUSTER_BASE_URL}/new`,
  NEW_FREE_GAMES: `${CLUSTER_BASE_URL}/new`,
  NEW_PAID_GAMES: `${CLUSTER_BASE_URL}/new`
};
...
function buildInitialUrl (opts) {
  ...
  // FIXME add a test for the other language scenario
  const queryString = {
    hl: 'us',
    gl: opts.country
  };
...
function parseCategoryApps (categoryObject, opts) {
  ...
  return request(options, opts.throttle)
    .then(scriptData.parse)
    .then(clusterObject => processAndRecur(clusterObject, opts, [], APP_MAPPINGS))
    .catch(console.error);
}
