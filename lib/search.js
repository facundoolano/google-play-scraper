...
function buildUrl(query) {
    var url = 'https://play.google.com/store/search?c=apps&q=' + query.term + '&hl=' + query.lang + '&gl=' + query.country + '&price=' + query.price;
...
function doSearch(query) {
    ...
    var delay = h.calcDelay(optsGlobal.throttle, request._last);
    return Promise
        .delay(delay)
        .then(function () {
          request._last = Date.now();
