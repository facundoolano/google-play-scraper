...
const {getParseList, getListWithPermissions} = require('./utils/parseList');
...
function search (opts) {
  return new Promise(function (resolve, reject) {
    ...
    opts = {
      ...
      withPermissions: opts.withPermissions,
      permissionsShort: opts.permissionsShort || false,
    ...
    initialRequest(opts)
      .then(getListWithPermissions(opts))
      .then(resolve)
      .catch(reject);
  });
}
