...
function checkFinished (opts, savedApps, nextToken, clp) {
  ...
  const requestString = querystring.unescape(querystring.stringify(data));

  const requestOptions = Object.assign({
    url: `https://play.google.com/store/apps/collection/search_results_cluster_apps?${requestString}`,
    method: 'GET',
