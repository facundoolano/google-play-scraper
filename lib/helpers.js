...
/*
 * Calculate desired delay between request time and throttle value
 */
module.exports.calcDelay = function (throttle, lastRequest) {

      if (!throttle || !lastRequest) {
        return 0;
      }
      var requestAge = Date.now() - lastRequest;
      return requestAge > throttle  ? 0 : throttle - requestAge;
