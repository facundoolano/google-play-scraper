...
function similar (opts) {
  return new Promise(function (resolve, reject) {
    ...
    const reqUrl = new URL(BASE_URL + '/store/apps/details');
    reqUrl.searchParams.append('id', mergedOpts.appId);
    reqUrl.searchParams.append('hl', 'en');
    reqUrl.searchParams.append('gl', mergedOpts.country);

    const similarUrl = reqUrl.toString();
